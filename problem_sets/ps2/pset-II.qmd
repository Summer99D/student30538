...
# Get the unique initial offense costs for each code
fine_amounts_lev1 = sticker_fines[['violation_code', 'fine_level1_amount']
].drop_duplicates()
...
print(parking_df[['issue_date', 'month', 'day', 'year']].head())

sticker_parking_df= parking_df[parking_df['sticker_violation_dummy']== 1]

alt.data_transformers.disable_max_rows()
##now I am going to plot it I will have 12 months on the X axis and then use mark_line to create different years!
line_chart = alt.Chart(sticker_parking_df).mark_line().encode(
    x=alt.X('month:O', sort=['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'], title='Month'),
    y=alt.Y('count()', title='Total Number of Tickets'),
